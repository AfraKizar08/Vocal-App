...
class Pallete {
  ...
  static const Color gradient1 = Color.fromRGBO(18, 69, 179, 1);
  static const Color gradient2 = Color.fromRGBO(21, 204, 36, 1);
  static const Color gradient3 = Color.fromRGBO(180, 42, 23, 1);
